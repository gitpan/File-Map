...
----------------------------------------------------------------------
    ...
    lib/File/ppport.h -- Perl/Pollution/Portability Version 3.24
    ...
    Use 'perldoc lib/File/ppport.h' to view the documentation below.
...
This version of F<lib/File/ppport.h> is designed to support operation with Perl
...
Display the version of F<lib/File/ppport.h>.
...
Tell F<lib/File/ppport.h> to check for compatibility with the given
Perl version. The default is to check for compatibility with Perl
version 5.003. You can use this option to reduce the output
of F<lib/File/ppport.h> if you intend to be backward compatible only
down to a certain Perl version.

=head2 --cplusplus

Usually, F<lib/File/ppport.h> will detect C++ style comments and
replace them with C style comments for portability reasons.
Using this option instructs F<lib/File/ppport.h> to leave C++
comments untouched.
...
Strip all script and documentation functionality from F<lib/File/ppport.h>.
This reduces the size of F<lib/File/ppport.h> dramatically and may be useful
if you want to include F<lib/File/ppport.h> in smaller modules without
increasing their distribution size too much.

The stripped F<lib/File/ppport.h> will have a C<--unstrip> option that allows
...
F<lib/File/ppport.h>. Also lists if it must be explicitly requested,
if it has dependencies, and if there are hints or warnings for it.

=head2 --list-unsupported

Lists the API elements that are known not to be supported by
F<lib/File/ppport.h> and below which version of Perl they probably
...
also deprecated. You can safely use the supported API, as F<lib/File/ppport.h>
...
more C<#define>s in your source code before the inclusion of F<lib/File/ppport.h>.
...
macro. Just C<#define> the macro before including C<lib/File/ppport.h>:
...
F<lib/File/ppport.h> on your source code. See the next section for
details.

=head1 EXAMPLES

To verify whether F<lib/File/ppport.h> is needed for your module, whether you
should make any changes to your code, and whether any special defines
should be used, F<lib/File/ppport.h> can be run as a Perl script to check your
...
If this version of F<lib/File/ppport.h> is causing failure during
the compilation of this module, please check if newer versions
of either this module or C<Devel::PPPort> are available on CPAN
before sending a bug report.

If F<lib/File/ppport.h> was generated using the latest version of
 ...
 */
#if PERL_REVISION != 5
#  error lib/File/ppport.h only works with Perl version 5
 ...
 * 5.005 perls, you can use aTHXR (supplied by lib/File/ppport.h), which will
...
/* Hint: SvPVbyte
 * Does not work in perl-5.6.1, lib/File/ppport.h implements a version
